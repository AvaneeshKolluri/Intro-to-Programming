...
class Car(object):
    ...
    def set_mpg(self,nmpg):
        self.__mpg = nmpg

    def set_tank_capacity(self,ntank_capacity):
        self.__tank_capacity = ntank_capacity
    ...
    def get_total_range(self):
       ...
       gas.'''
        totRang = self.__tank_capacity*self.__mpg
        return totRang
...
class HybridCar(Car):  
    ...
    def get_total_range(self):
        return self.get_battery_range() + Car.get_total_range(self)
